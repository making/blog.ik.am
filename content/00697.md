---
title: Tanzu Application Platform 1.1 (Iterate Profile) を4 cpu, 8 GB memoryのminikubeにLocal Registryを使ってにインストールするメモ
...
本記事ではTAPをMinukubeにLocal Registryを使ってInstallし、"Hello World"なアプリケーションをソースコードからデプロイする機能("Source to URL")を試します。

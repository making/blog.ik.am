...
date: 2026-05-22T04:50:55.866404508Z
updated: 2026-05-22T04:50:55.866404508Z
---
...
```bash
orb create rocky:9 gp-coordinator -c user-data.yml
orb create rocky:9 gp-segment1 -c user-data.yml
orb create rocky:9 gp-segment2 -c user-data.yml
orb create rocky:9 gp-segment3 -c user-data.yml
```

...
まずはインストールフォルダ`$HOME/clouddrive/bin`を作成し、環境変数`PATH`を`$HOME/.bash_profile`に設定します。

```sh
mkdir -p $HOME/clouddrive/bin
echo 'export PATH=$PATH:$HOME/clouddrive/bin' >> $HOME/.bash_profile
...
diego_cell/a928216d-f2ba-429b-82fa-0ac01c8d4494                     running        null  10.0.0.20  agent_id:38ea257e-bfd3-42f7-a75f-d6ac35df9174;resource_group_name:pas  Standard_DS11_v2  true

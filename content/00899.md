...
Vault のシール設定で使用する `tenant_id`、`client_id`、`client_secret`、`vault_name`、`key_name` を取得し、`seal "azurekeyvault"` ブロックとして出力します。  

...
[`96750e5088eb49ebfc65af49caf97a9c5c2ada5a`](https://github.com/pivotal-cf/terraforming-aws/tree/96750e5088eb49ebfc65af49caf97a9c5c2ada5a)で確認しています。
...
properties-configuration:
  director_configuration:
    ...
    # BOSH DirectorのBlobstoreの場所。ここではvSphere版と同等な設定を想定してあえてS3ではなく、Internal Blobstoreを使用する
...
product-properties:
  ...
  .properties.credhub_database:
    value: internal_mysql 
  # Blobstoreの設定。ここではExternal(S3など)ではなくInternal(WebDAV)を選択。

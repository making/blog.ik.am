...
* Build ... コンテナイメージをビルドしてレポジトリにpushする
  * [Function](https://projectriff.io/blog/2019/08/21/announcing-riff-0-4-0#function-builds) ... [Function Invokers](https://projectriff.io/docs/v0.4/invokers)のCloud Native Buildpacksを使って関数を実装したソースコードからイメージを作成。
  * [Application](https://projectriff.io/blog/2019/08/21/announcing-riff-0-4-0#application-builds) ... [Cloud FoundryのCloud Native Buildpacks](https://hub.docker.com/r/cloudfoundry/cnb)を使って普通のアプリケーションソースコードからのイメージを作成
  * [Container](https://projectriff.io/blog/2019/08/21/announcing-riff-0-4-0#container-builds) ... 既存のイメージを使用。
...
まずは[https://github.com/projectriff-samples/node-square](https://github.com/projectriff-samples/node-square)のサンプルを使用します。二乗を計算する関数です。

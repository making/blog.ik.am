...
Googleが公開した[Gemma 3](https://blog.google/technology/developers/gemma-3/)をllama-cppで動かし、 OpenAI API経由でアクセスします。また、Spring AIを経由してこのAPIにアクセスし、Tool CallingやMCP連携を試します。
...
正しそうです。MCP Serverから取得した情報を日本語に翻訳することもできました。

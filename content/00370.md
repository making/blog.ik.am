...
cf-releaseの[リリースページ](https://github.com/cloudfoundry/cf-release/releases/tag/v226#recommended-diego-version)のバージョンに合わせて、diego-release、garden-linux、etcd-releaseの作成済みbosh releaseを[bosh.io](https://bosh.io)からデプロイ。

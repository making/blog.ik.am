...
![image.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/1852/319ead47-a20e-434e-b9ad-873ddfad6c3f.png)


"I agree to theTerms and Conditions"にチェックを入れて、

![image.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/1852/61af2ba4-e3b6-43de-9dc9-52c7131facb8.png)


EL9用のインストーラーを`~/Downlodas`にダウンロードします。

![image.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/1852/190f18ae-e503-49a7-87c7-a37e946b9fba.png)
...
`libssh2`(その他、あると便利な)パッケージをインストール
...
ちなみん、[バージョン17](https://techdocs.broadcom.com/us/en/vmware-tanzu/data-solutions/tanzu-for-postgres/17-7/tnz-postgres/software-components.html)まではpgvectorなど、より多くの拡張がサポートされていましたが、バージョン18では未対応なようです。

### データベースとユーザーの作成

https://docs.vultr.com/how-to-install-postgresql-database-server-on-ubuntu-22-04 を参考に、`hospital`データベースと`db_manager`ユーザーを作成し、適切な権限を付与します。
...
ALTER DEFAULT PRIVILEGES IN SCHEMA public
GRANT ALL PRIVILEGES ON SEQUENCES TO db_manager;
"
```

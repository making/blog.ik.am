...
> 記事執筆時点ではRabbitMQ StreamsはObservailityが[未対応](https://github.com/spring-projects/spring-amqp/issues/2467)だったので、Outboxパターンの実装にフォーカスできるように普通のRabbitMQを使用しました。
...
Zipkinで`6475d2851c60c07b94f48ba27be40330`を見てみましょう。

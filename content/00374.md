...
Enter a password to use in example_manifests/multiple-vm-cf.yml [c1oudc0w]:パスワード
Please double check your password [Just6ock]. Type yes to continue:yes
```
...
`~/example_manifests/multiple-vm-cf.yml `中の`13.78.121.100.xip.io`を`azurecf.ik.am`に置換して`bosh deploy`。

...
その他、.NETを使う方法やMySQL(▶️ [書きました](https://blog.ik.am/entries/390))、MongoDBのサービスブローカーを使う方法、Azureのロードバランサーと連携する方法などは[こちら](https://github.com/cloudfoundry-incubator/bosh-azure-cpi-release/tree/master/docs#3-advanced-configurations-and-deployments)を参照。

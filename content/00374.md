...
`~/example_manifests/multiple-vm-cf.yml`(シングルVMの場合は`~/example_manifests/single-vm-cf.yml`)の
...
記事執筆時点で新しいバージョンのcf-release [v238](https://github.com/cloudfoundry/cf-release/releases/tag/v238)が使えている。

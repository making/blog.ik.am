...
### CFCR(Cloud Foundry Container Runtime)とは
...
<img src="https://docs-cfcr.cfapps.io/images/common/certified_kubernetes_1.8_color.png" height="180px">
...
export cluster_name=my-kubo
export user_name=cfcr-admin
export context_name=my-kubo
...
`http://(worker_host):32300`でアプリケーションにアクセスできます。この記事ではworker_host=10.244.1.93です。

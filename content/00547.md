...
[](/entries/542)ではCustom Builderを使ってnative imageのDocker Imageを作成する方法を紹介しましたが、Paketo Buildpackで正式にGraalVM buildpackが同梱されたため、改めて紹介します。
...
* `paketobuildpacks/builder:tiny` builderには`java-native-image`が含まれています。`tiny`のベースイメージは最小構成のイメージであり、実行可能なnative imageを実行する環境として最適化されています。
...
まずはソースコードを用意します。執筆段階ではspring-graalvm-native 0.8.0が使われ、Spring Boot 2.4が必要です。ここでは`2.4.0-SNAPSHOT`を使用します。
...
pack build hello \
  ...
  -e BP_BOOT_NATIVE_IMAGE_BUILD_ARGUMENTS="-Dspring.native.remove-yaml-support=true -Dspring.spel.ignore=true"
```
...
Paketo Spring Boot Native Image Buildpack 1.3.0
  ...
  Spring GraalVM Native Feature 0.8.0
    ...
    Verifying checksum
    Executing native-image -Dspring.native.remove-yaml-support=true -Dspring.spel.ignore=true -H:+StaticExecutableWithDynamicLibC -H:Name=/layers/paketo-buildpacks_spring-boot-native-image/native-image/com.example.HelloApplication -cp /workspace:/workspace/BOOT-INF/classes:/workspace/BOOT-INF/lib/spring-boot-starter-actuator-2.4.0-SNAPSHOT.jar:/workspace/BOOT-INF/lib/spring-boot-starter-2.4.0-SNAPSHOT.jar:/workspace/BOOT-INF/lib/spring-boot-2.4.0-SNAPSHOT.jar:/workspace/BOOT-INF/lib/spring-context-5.3.0-SNAPSHOT.jar:/workspace/BOOT-INF/lib/spring-aop-5.3.0-SNAPSHOT.jar:/workspace/BOOT-INF/lib/spring-expression-5.3.0-SNAPSHOT.jar:/workspace/BOOT-INF/lib/spring-boot-autoconfigure-2.4.0-SNAPSHOT.jar:/workspace/BOOT-INF/lib/spring-boot-starter-logging-2.4.0-SNAPSHOT.jar:/workspace/BOOT-INF/lib/logback-classic-1.2.3.jar:/workspace/BOOT-INF/lib/logback-core-1.2.3.jar:/workspace/BOOT-INF/lib/log4j-to-slf4j-2.13.3.jar:/workspace/BOOT-INF/lib/log4j-api-2.13.3.jar:/workspace/BOOT-INF/lib/jul-to-slf4j-1.7.30.jar:/workspace/BOOT-INF/lib/jakarta.annotation-api-1.3.5.jar:/workspace/BOOT-INF/lib/snakeyaml-1.26.jar:/workspace/BOOT-INF/lib/spring-boot-actuator-autoconfigure-2.4.0-SNAPSHOT.jar:/workspace/BOOT-INF/lib/spring-boot-actuator-2.4.0-SNAPSHOT.jar:/workspace/BOOT-INF/lib/jackson-databind-2.11.2.jar:/workspace/BOOT-INF/lib/jackson-annotations-2.11.2.jar:/workspace/BOOT-INF/lib/jackson-core-2.11.2.jar:/workspace/BOOT-INF/lib/jackson-datatype-jsr310-2.11.2.jar:/workspace/BOOT-INF/lib/micrometer-core-1.5.4.jar:/workspace/BOOT-INF/lib/HdrHistogram-2.1.12.jar:/workspace/BOOT-INF/lib/LatencyUtils-2.0.3.jar:/workspace/BOOT-INF/lib/spring-boot-starter-webflux-2.4.0-SNAPSHOT.jar:/workspace/BOOT-INF/lib/spring-boot-starter-json-2.4.0-SNAPSHOT.jar:/workspace/BOOT-INF/lib/jackson-datatype-jdk8-2.11.2.jar:/workspace/BOOT-INF/lib/jackson-module-parameter-names-2.11.2.jar:/workspace/BOOT-INF/lib/spring-boot-starter-reactor-netty-2.4.0-SNAPSHOT.jar:/workspace/BOOT-INF/lib/reactor-netty-http-1.0.0-SNAPSHOT.jar:/workspace/BOOT-INF/lib/netty-codec-http-4.1.51.Final.jar:/workspace/BOOT-INF/lib/netty-common-4.1.51.Final.jar:/workspace/BOOT-INF/lib/netty-buffer-4.1.51.Final.jar:/workspace/BOOT-INF/lib/netty-transport-4.1.51.Final.jar:/workspace/BOOT-INF/lib/netty-codec-4.1.51.Final.jar:/workspace/BOOT-INF/lib/netty-handler-4.1.51.Final.jar:/workspace/BOOT-INF/lib/netty-codec-http2-4.1.51.Final.jar:/workspace/BOOT-INF/lib/netty-resolver-dns-4.1.51.Final.jar:/workspace/BOOT-INF/lib/netty-resolver-4.1.51.Final.jar:/workspace/BOOT-INF/lib/netty-codec-dns-4.1.51.Final.jar:/workspace/BOOT-INF/lib/netty-transport-native-epoll-4.1.51.Final-linux-x86_64.jar:/workspace/BOOT-INF/lib/netty-transport-native-unix-common-4.1.51.Final.jar:/workspace/BOOT-INF/lib/reactor-netty-core-1.0.0-SNAPSHOT.jar:/workspace/BOOT-INF/lib/netty-handler-proxy-4.1.51.Final.jar:/workspace/BOOT-INF/lib/netty-codec-socks-4.1.51.Final.jar:/workspace/BOOT-INF/lib/spring-web-5.3.0-SNAPSHOT.jar:/workspace/BOOT-INF/lib/spring-beans-5.3.0-SNAPSHOT.jar:/workspace/BOOT-INF/lib/spring-webflux-5.3.0-SNAPSHOT.jar:/workspace/BOOT-INF/lib/nio-multipart-parser-1.1.0.jar:/workspace/BOOT-INF/lib/slf4j-api-1.7.30.jar:/workspace/BOOT-INF/lib/nio-stream-storage-1.1.3.jar:/workspace/BOOT-INF/lib/spring-core-5.3.0-SNAPSHOT.jar:/workspace/BOOT-INF/lib/spring-jcl-5.3.0-SNAPSHOT.jar:/workspace/BOOT-INF/lib/reactor-core-3.4.0-SNAPSHOT.jar:/workspace/BOOT-INF/lib/reactive-streams-1.0.3.jar:/workspace/BOOT-INF/lib/spring-boot-jarmode-layertools-2.4.0-SNAPSHOT.jar:/tmp/0c24ece155eaac02cb106cced886ff70f83a02e13e63102f8242bd0d6b4ad5e2/spring-graalvm-native-0.8.0.jar com.example.HelloApplication
...
```
[INFO] --- spring-boot-maven-plugin:2.4.0-SNAPSHOT:build-image (default-cli) @ hello ---

...
echo "/exit" | ./build/bin/llama-cli -hf unsloth/Qwen3.5-122B-A10B-GGUF:MXFP4_MOE
echo "/exit" | ./build/bin/llama-cli -hf Jackrong/Qwen3.5-27B-Claude-4.6-Opus-Reasoning-Distilled-v2-GGUF
...
; https://forums.developer.nvidia.com/t/running-a-local-llm-with-claude-code-and-llama-cpp-on-jetson-thor-and-rtx-5090/364740
n-gpu-layers = 999
jinja = true
temp = 0.6
top-p = 0.95

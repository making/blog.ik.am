...
[cf-for-k8s(CF4K8s) 0.4.0をKind上にインストールする](https://blog.ik.am/entries/519)同様に、[Kind](https://github.com/kubernetes-sigs/kind)をLaptopにインストールし、その上にCloud Foundryをクリーンインストールします。

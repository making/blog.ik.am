...
categories: ["Dev", "CaaS", "Kubernetes", "TKG", "vSphere", "Pinniped"]
---
...
問題がなければ`kubectl appy`でManagement Clusterに対して適用します。
...
### Pinnpedを経由してkubeconfigを取得

https://docs.vmware.com/en/VMware-Tanzu-Kubernetes-Grid/1.3/vmware-tanzu-kubernetes-grid-13/GUID-cluster-lifecycle-connect.html#id-mgmt
...
https://docs.vmware.com/en/VMware-Tanzu-Kubernetes-Grid/1.3/vmware-tanzu-kubernetes-grid-13/GUID-mgmt-clusters-configure-id-mgmt.html#authenticate-users-on-a-machine-without-a-browser-6

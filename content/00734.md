...
アプリ側は[Micrometer Prometheus](https://micrometer.io/docs/registry/prometheus)をライブラリに加えると`/actuator/prometheus`エンドポイントでPrometheus形式で公開できます(rest-servicesは設定済みです)。

---
title: Tanzu Application PlatformでPre-ProvisionなRabbitMQを使ってResourceClaim / ClassClaimを作る
tags: ["Kubernetes", "Cartographer", "kind", "Tanzu", "TAP", "Bitnami Services", "Spring Boot", "Spring Cloud Stream", "Spring Cloud Data Flow", "RabbitMQ"]
...
本記事では次の方向けに、Pre-ProvisionなRabbitMQを使ってResourceClaim / ClassClaimを作る方法を紹介します。
...
FREEプランのあるRabbitMQのSaaSである[CloudAMQP](https://www.cloudamqp.com)を使ってみます。

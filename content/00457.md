...
for spot in ${SPOT_INSTANCES};do
  ...
  echo "--name name = spot-instance-${TYPE}"
  echo '{"spot_bid_price":"'$PRICE'", "spot_ondemand_fallback": true}'
...
om --target "https://${OPSMAN_DOMAIN_OR_IP_ADDRESS}" \
   ...
   --cloud-properties '{"spot_bid_price":"0.0320", "spot_ondemand_fallback": true}'
```

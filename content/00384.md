...
``` console
bosh upload stemcell https://bosh.io/d/stemcells/bosh-azure-hyperv-ubuntu-trusty-go_agent?v=3262
bosh upload release https://bosh.io/d/github.com/concourse/concourse?v=1.3.1

...
[こちらのドキュメント](https://docs.vmware.com/en/VMware-Spring-Cloud-Data-Flow-for-Kubernetes/1.4/scdf-k8s/GUID-getting-started-pipeline.html) のように`http | aplitter | log`という簡単なストリームを作成します。
...
パラメータを設定します。ここでは`http`の"Deployment Platform"の"EDIT"ボタンをクリックしてください。

![image](https://user-images.githubusercontent.com/106908/147912853-7f6d35d9-f373-4354-92d4-e5f76c7356a2.png)

`create-loadbalancer`にチェックを入れ、"UPDATE"ボタンをクリックしてください。

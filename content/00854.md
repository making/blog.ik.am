...
![gemfire-cluster.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/1852/da89f953-802c-4bac-959a-95c6fa23ebb0.png)
...
再起動後、server-1にデータが配置され、totalRegionEntryCount = 2 となりました：

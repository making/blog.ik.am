...
api-auto-registration       api-auto-registration-cert                   True    api-auto-registration-cert                   tap-ingress-selfsigned                       Certificate is up to date and has not expired   3h19m
cert-manager                tap-ingress-selfsigned-root-ca               True    tap-ingress-selfsigned-root-ca               tap-ingress-selfsigned-bootstrap             Certificate is up to date and has not expired   3h26m
demo                        route-d5db536e-70b3-443d-a70d-00f898079280   True    route-d5db536e-70b3-443d-a70d-00f898079280   tap-ingress-selfsigned                       Certificate is up to date and has not expired   125m
metadata-store              amr-cloudevent-handler-ingress-cert          True    amr-cloudevent-handler-ingress-cert          tap-ingress-selfsigned                       Certificate is up to date and has not expired   3h19m
metadata-store              amr-ingress-cert                             True    amr-ingress-cert                             tap-ingress-selfsigned                       Certificate is up to date and has not expired   3h19m
metadata-store              ingress-cert                                 True    ingress-cert                                 tap-ingress-selfsigned                       Certificate is up to date and has not expired   3h19m
tap-gui                     tap-gui-cert                                 True    tap-gui-cert                                 tap-ingress-selfsigned                       Certificate is up to date and has not expired   3h19m
```
...
api-auto-registration       api-auto-registration-cert                   True    api-auto-registration-cert                   letsencrypt                                  Certificate is up to date and has not expired   13h
demo                        route-d5db536e-70b3-443d-a70d-00f898079280   True    route-d5db536e-70b3-443d-a70d-00f898079280   letsencrypt                                  Certificate is up to date and has not expired   65s
metadata-store              amr-cloudevent-handler-ingress-cert          True    amr-cloudevent-handler-ingress-cert          letsencrypt                                  Certificate is up to date and has not expired   13h
metadata-store              amr-ingress-cert                             True    amr-ingress-cert                             letsencrypt                                  Certificate is up to date and has not expired   13h
metadata-store              ingress-cert                                 True    ingress-cert                                 letsencrypt                                  Certificate is up to date and has not expired   13h
tap-gui                     tap-gui-cert                                 True    tap-gui-cert                                 letsencrypt                                  Certificate is up to date and has not expired   13h
```

> 
> ```
> Message:                 The certificate request has failed to complete and will be retried: Failed to wait for order resource "tap-gui-cert-84tvm-324749186" to become ready: order is in "errored" state: Failed to create Order: 429 urn:ietf:params:acme:error:rateLimited: Error creating new order :: too many certificates already issued for "nip.io". Retry after 2023-12-12T17:00:00Z: see https://letsencrypt.org/docs/rate-limits/
> ```
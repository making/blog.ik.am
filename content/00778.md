...
ip-192-168-19-134.ap-northeast-1.compute.internal   Ready    <none>   5m31s   v1.28.3-eks-e71965b   192.168.19.134   35.78.100.84     Amazon Linux 2   5.10.199-190.747.amzn2.x86_64   containerd://1.7.2
ip-192-168-39-153.ap-northeast-1.compute.internal   Ready    <none>   5m32s   v1.28.3-eks-e71965b   192.168.39.153   54.199.122.212   Amazon Linux 2   5.10.199-190.747.amzn2.x86_64   containerd://1.7.2
ip-192-168-79-97.ap-northeast-1.compute.internal    Ready    <none>   5m31s   v1.28.3-eks-e71965b   192.168.79.97    43.207.126.145   Amazon Linux 2   5.10.199-190.747.amzn2.x86_64   containerd://1.7.2
```
...
IMGPKG_REGISTRY_PASSWORD=$TANZUNET_PASSWORD \
imgpkg copy \
  -b registry.tanzu.vmware.com/tanzu-application-platform/tap-packages:1.7.2 \
  --to-tar tap-bundle-1.7.2.tar \
  --include-non-distributable-layers
```
...
```
tanzu package install tap -p tap.tanzu.vmware.com -v 1.7.2 --values-file tap-values.yaml -n tap-install
```
...
IMGPKG_REGISTRY_PASSWORD=$TANZUNET_PASSWORD \
imgpkg copy \
  -b registry.tanzu.vmware.com/tanzu-application-platform/full-deps-package-repo:1.7.2 \
  --to-tar full-deps-1.7.2.tar \
  --include-non-distributable-layers
...
accelerator                          accelerator.apps.tanzu.vmware.com                     1.7.6             Reconcile succeeded   33m
amr-observer                         amr-observer.apps.tanzu.vmware.com                    0.2.1             Reconcile succeeded   33m
api-auto-registration                apis.apps.tanzu.vmware.com                            0.4.1             Reconcile succeeded   33m
appliveview                          backend.appliveview.tanzu.vmware.com                  1.7.3             Reconcile succeeded   33m
appliveview-apiserver                apiserver.appliveview.tanzu.vmware.com                1.7.3             Reconcile succeeded   35m
appliveview-connector                connector.appliveview.tanzu.vmware.com                1.7.3             Reconcile succeeded   35m
appliveview-conventions              conventions.appliveview.tanzu.vmware.com              1.7.3             Reconcile succeeded   34m
base-jammy-builder                   base-jammy-builder.buildpacks.tanzu.vmware.com        0.1.0             Reconcile succeeded   26m
base-jammy-stack                     base-jammy-stack.buildpacks.tanzu.vmware.com          0.1.67            Reconcile succeeded   27m
bitnami-services                     bitnami.services.tanzu.vmware.com                     0.3.1             Reconcile succeeded   34m
buildservice                         buildservice.tanzu.vmware.com                         1.12.4            Reconcile succeeded   35m
cartographer                         cartographer.tanzu.vmware.com                         0.8.5             Reconcile succeeded   35m
cert-manager                         cert-manager.tanzu.vmware.com                         2.4.2             Reconcile succeeded   35m
cnrs                                 cnrs.tanzu.vmware.com                                 2.4.3             Reconcile succeeded   33m
contour                              contour.tanzu.vmware.com                              1.25.3            Reconcile succeeded   35m
crossplane                           crossplane.tanzu.vmware.com                           0.3.0             Reconcile succeeded   35m
developer-conventions                developer-conventions.tanzu.vmware.com                0.14.1            Reconcile succeeded   34m
dotnet-core-buildpack                dotnet-core.buildpacks.tanzu.vmware.com               2.8.3             Reconcile succeeded   27m
fluxcd-source-controller             fluxcd.source.controller.tanzu.vmware.com             0.36.1+tanzu.2    Reconcile succeeded   35m
full-deps                            full-deps.buildservice.tanzu.vmware.com               1.7.45            Reconcile succeeded   27m
full-jammy-builder                   full-jammy-builder.buildpacks.tanzu.vmware.com        0.1.0             Reconcile succeeded   26m
full-jammy-stack                     full-jammy-stack.buildpacks.tanzu.vmware.com          0.1.119           Reconcile succeeded   27m
go-buildpack                         go.buildpacks.tanzu.vmware.com                        2.2.3             Reconcile succeeded   27m
grype-scanner-demo                   grype.scanning.apps.tanzu.vmware.com                  1.7.2             Reconcile succeeded   19m
java-buildpack                       java.buildpacks.tanzu.vmware.com                      9.12.1            Reconcile succeeded   27m
java-native-image-buildpack          java-native-image.buildpacks.tanzu.vmware.com         7.10.1            Reconcile succeeded   27m
local-source-proxy                   local-source-proxy.apps.tanzu.vmware.com              0.2.1             Reconcile succeeded   35m
metadata-store                       metadata-store.apps.tanzu.vmware.com                  1.7.2             Reconcile succeeded   33m
namespace-provisioner                namespace-provisioner.apps.tanzu.vmware.com           0.5.0             Reconcile succeeded   34m
nodejs-buildpack                     nodejs.buildpacks.tanzu.vmware.com                    2.3.3             Reconcile succeeded   27m
ootb-delivery-basic                  ootb-delivery-basic.tanzu.vmware.com                  0.14.8            Reconcile succeeded   34m
ootb-supply-chain-testing-scanning   ootb-supply-chain-testing-scanning.tanzu.vmware.com   0.14.8            Reconcile succeeded   34m
ootb-templates                       ootb-templates.tanzu.vmware.com                       0.14.8            Reconcile succeeded   34m
php-buildpack                        php.buildpacks.tanzu.vmware.com                       2.6.2             Reconcile succeeded   27m
procfile-buildpack                   procfile.buildpacks.tanzu.vmware.com                  5.6.1             Reconcile succeeded   27m
python-buildpack                     python.buildpacks.tanzu.vmware.com                    2.5.3             Reconcile succeeded   27m
ruby-buildpack                       ruby.buildpacks.tanzu.vmware.com                      2.8.2             Reconcile succeeded   27m
scanning                             scanning.apps.tanzu.vmware.com                        1.7.3             Reconcile succeeded   35m
service-bindings                     servicebinding.tanzu.vmware.com                       0.10.2            Reconcile succeeded   35m
services-toolkit                     services-toolkit.tanzu.vmware.com                     0.12.0            Reconcile succeeded   35m
source-controller                    controller.source.apps.tanzu.vmware.com               0.8.3             Reconcile succeeded   35m
spring-boot-conventions              spring-boot-conventions.tanzu.vmware.com              1.7.3             Reconcile succeeded   34m
tap                                  tap.tanzu.vmware.com                                  1.7.2             Reconcile succeeded   35m
tap-auth                             tap-auth.tanzu.vmware.com                             1.1.0             Reconcile succeeded   35m
tap-gui                              tap-gui.tanzu.vmware.com                              1.7.8             Reconcile succeeded   33m
tap-telemetry                        tap-telemetry.tanzu.vmware.com                        0.7.0             Reconcile succeeded   35m
tekton-pipelines                     tekton.tanzu.vmware.com                               0.50.3+tanzu.3    Reconcile succeeded   35m
tiny-jammy-builder                   tiny-jammy-builder.buildpacks.tanzu.vmware.com        0.1.0             Reconcile succeeded   26m
tiny-jammy-stack                     tiny-jammy-stack.buildpacks.tanzu.vmware.com          0.1.71            Reconcile succeeded   27m
web-servers-buildpack                web-servers.buildpacks.tanzu.vmware.com               0.15.5            Reconcile succeeded   27m
```

```
$ kubectl get svc -n tanzu-system-ingress envoy
NAME    TYPE           CLUSTER-IP       EXTERNAL-IP                                                                          PORT(S)                      AGE
envoy   LoadBalancer   10.100.134.137   a86b277fdcee04ad1b8ea627f764125a-fdcfcd0994f4ee0e.elb.ap-northeast-1.amazonaws.com   80:30290/TCP,443:30392/TCP   8m25s
```

```
$ kubectl get svc -n tanzu-system-ingress envoy -ojsonpath='{.status.loadBalancer.ingress[0].hostname}'
a86b277fdcee04ad1b8ea627f764125a-fdcfcd0994f4ee0e.elb.ap-northeast-1.amazonaws.com
```
...
base-jammy   532912407632.dkr.ecr.ap-northeast-1.amazonaws.com/tap-build-service:base-jammy-builder@sha256:4ebbfe424b45e96c8ecf2cc3e8d1e868c96a0054aa6097a4228d554f99016e35   True
default      532912407632.dkr.ecr.ap-northeast-1.amazonaws.com/tap-build-service:default-builder@sha256:5c02d8b592ede9e65b089a1fa33b2df7f397a698c0bfd2e315f91c2f7c31a104      True
full-jammy   532912407632.dkr.ecr.ap-northeast-1.amazonaws.com/tap-build-service:full-jammy-builder@sha256:8810073f4b0e9921bfd37fe20b23ebee38d54cabe9d010c75c38f9080d7e426c   True
tiny-jammy   532912407632.dkr.ecr.ap-northeast-1.amazonaws.com/tap-build-service:tiny-jammy-builder@sha256:53397bb2aa18bb7517c0164e48f2df2ac3de54e42430d880718038b230c50151   True
```

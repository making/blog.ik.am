...
[前回](https://blog.ik.am/entries/420)、MinikubeでKubernetesを始めてみたが、
今度は[Google Container Engine (GKE)](https://cloud.google.com/container-engine)で試す。
...
hello-tomcat   1         1         1            1           41s       hello-tomcat   making/hello-tomcat   run=hello-tomcat
...
hello-tomcat-1638778051   1         1         1         1m        hello-tomcat   making/hello-tomcat   pod-template-hash=1638778051,run=hello-tomcat
```
...
Events:
  ...
  9m		9m		1	kubelet, gke-hello-kube-default-pool-29d9abc0-lhcm	spec.containers{hello-tomcat}	Normal		Pulling		pulling image "making/hello-tomcat"
  9m		9m		1	kubelet, gke-hello-kube-default-pool-29d9abc0-lhcm	spec.containers{hello-tomcat}	Normal		Pulled		Successfully pulled image "making/hello-tomcat"
...
> **メモ**
> 
> `g1-small`インスタンスだとリソース不足で3インスタンスにできなかった。
...
NAME           DESIRED   CURRENT   UP-TO-DATE   AVAILABLE   AGE       CONTAINER(S)   IMAGE(S)              SELECTOR
hello-tomcat   2         2         2            2           29m       hello-tomcat   making/hello-tomcat   run=hello-tomcat
...
NAME                      DESIRED   CURRENT   READY     AGE       CONTAINER(S)   IMAGE(S)              SELECTOR
hello-tomcat-1638778051   2         2         2         30m       hello-tomcat   making/hello-tomcat   pod-template-hash=1638778051,run=hello-tomcat
```
...
NAME                      DESIRED   CURRENT   UP-TO-DATE   AVAILABLE   AGE       CONTAINER(S)   IMAGE(S)              SELECTOR
hello-tomcat-deployment   2         2         2            2           42s       hello-tomcat   making/hello-tomcat   run=hello-tomcat
